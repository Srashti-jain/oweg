              ...
              <h5 class="section-title">{{ __('staticwords.Price') }} ({{ Session::get('currency')['id'] }})</h5>             
               <div class="sidebar-widget-body outer-top-xs">
                ...
                <div class="slider-range-text-block position-relative z-index11">
                  <input type="text" id="amountstart" name="amountstart" value="" class="slider-range-text" style="background-color:#84c23f">
                  <input type="text" id="amountend" name="amountend" value="" class="slider-range-text text-right" style="background-color:#84c23f">
                </div>
